  ...
  const lightTheme = createTheme(
    {
      ...
      palette: {
        primary: { main: system.color.lightTheme.palette.primary || "#3D23CC" },
        secondary: { main: system.color.lightTheme.palette.secondary || "#3D23CC" },
        toolbar: { main: system.color.lightTheme.toolbar.background || "#3D23CC" },
